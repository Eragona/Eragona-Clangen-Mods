...
class Sprites:
    ...
    def load_all(self):
        ...
        for x in [
            ...
            'eragonatorite2',  'brindlecolours', 'wildcatcolours', 'wolfcolours', 'spotscolours', 'smokepointcolours',
            'lynxcolours', 'finleappatchescolours', "harnesses", "bows", "teethcollars", "bandanas",
            "french_scarves", "ties",
        ]:
